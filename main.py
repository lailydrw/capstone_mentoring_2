...
st.markdown("**Grafik Perubahan Harga Gula Nasional**")
...
with col2:
    st.markdown("**Grafik Perubahan Harga Gula Interasional**")
    st.line_chart(harga.set_index('tanggal')[['harga_gula_internasional']])
    # fig=plt.figure()
